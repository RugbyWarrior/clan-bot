...
function resolveSheetColumn(
  ...
  return (
    headerToColumn[trimmed] ||
    null
  );
}

function columnLetterToIndex(
  columnLetter
) {
  return (
    columnLetter
...
function getMosSheetValueFromMember(
  member,
  guild,
  mos
) {
...
module.exports = {
  data: new SlashCommandBuilder()
    .setName('auditmos')
    .setDescription(
      'Audit MOS values in the Ratings sheet against Discord MOS roles.'
    ),
  ...
  async execute(interaction) {
    ...
    try {
      ...
      return interaction.editReply({
        content:
          '❌ There was an error while running /auditmos.',
        allowedMentions: {
          users: [],
        },
      });
